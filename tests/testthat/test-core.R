...
test_that("generate_data respects signal strength", {
  d_lo <- generate_data(n = 5000, p = 10, signal_strength = 0.1, noise_sd = 0)
  d_hi <- generate_data(n = 5000, p = 10, signal_strength = 10,  noise_sd = 0)
